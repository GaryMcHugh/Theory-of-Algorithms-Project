...
According to [crosswordtools](http://www.crosswordtools.com/numbers-game/faq.php) there are 13243 different possible ways of representing an ordered list of six numbers. The calculation which they have used is shown below:
